    ...
    <section>
     <div class="container">
      <div class="viewLernerClass">
        <h1>Modify Lerner Details</h1>
          <div class="companyApprovalForm" >
            <input type="text" name="instactorId" id="searchId" placeholder="Enter Learner Id"> 
            <input type="submit" class="btn submitButton" id="update" 
              onclick="updateFunc(document.getElementById('searchId').value,'learner')" value="Update">
            <input type="submit" class="btn submitButton" id="delete" 
            onclick="deleteFunc(document.getElementById('searchId').value,'learner')" value="Delete">
